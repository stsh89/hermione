...
mod tests {
    ...
    fn test_rate_limit_error_message() {
        ...
        assert_eq!(err.to_string(), "Notion API request failure. Please retry in 230m")
    }
    ...
    fn test_status_code_error_message() {
        ...
        assert_eq!(err.to_string(), "Notion API request failed with status code 404")
    }
    ...
    fn test_transport_error_message() {
        ...
        assert_eq!(err.to_string(), "Notion API request failure: Cannot resolve the target name.");
    }
}
